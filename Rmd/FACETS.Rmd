...
title:  | 
  ...
  | 
  | 
author: Created by Drs Matthew Courtney (PhD, Ed), Xxxxx Xxxxx (PhD, Xx), Xxxxx Xxxxx (PhD, Xx), & Xxxxxx Xxxxx (PhD, Xx)
...
list.of.data <- list("Ordered Person Results" = Person.stats.o, "Ordered Item Difficulties(thresholds)" = Thresh.vec, 
                     ...
                     "Many Facets Analysis" = facet.df.results)
