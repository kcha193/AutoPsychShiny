...
title:  | 
  ...
  |
  | 
  | Technical Report, version 1PLM_FACETS 0.1.0
  |
  |
  | 
  |
...
where $\theta_n$ the person ability, $\delta_i$ is the item difficulty, and $a$ is the scaling factor of 1.702 in order to match the logistic and probit metrics very closely (Lord & Novick, 1968) .  
...
## A9. Summary of Input Paramters, Analysis, and Outputs
